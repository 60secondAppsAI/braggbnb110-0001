<template>
  <div class="app-header">
    <div>
      <router-link to="/">
    	<section class="section-1">
    		<div class="title">
				<span data-desktop-color="rgba(0,97,249,1)" style="color: rgb(0, 97, 249);">Braggbnb110</span>
			</div>
			<div class="subtitle">
    ...
    <div class="links">
      <nav class="nav">
	        <router-link class="link" to="/users">My Users</router-link>
            
							        <router-link class="link" to="/signup">Create your art</router-link>
        <router-link class="link" to="/users">Menu-item-1</router-link>
        <router-link class="link" to="/signup">Menu-item-2</router-link>
        <router-link class="link" to="/arts-gallery">Menu-item-3</router-link>
