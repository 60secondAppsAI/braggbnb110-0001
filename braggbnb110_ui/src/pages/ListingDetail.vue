              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Description</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Location</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Location" type="text" placeholder="Enter Location" v-model="listingDetails.location"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Price Per Night</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PricePerNight" type="text" placeholder="Enter PricePerNight" v-model="listingDetails.pricePerNight"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Max Guests</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="MaxGuests" type="text" placeholder="Enter MaxGuests" v-model="listingDetails.maxGuests"></input>
																		</div>
						</td>
														</tr>
