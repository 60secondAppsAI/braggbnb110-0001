						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Name" type="text" placeholder="Enter Name" v-model="userToAdd.name"></base-input>
								  ...
								  <base-input label="PhoneNumber" type="text" placeholder="Enter PhoneNumber" v-model="userToAdd.phoneNumber"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="userDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					...
					<td class="detail_view_column_2">Phone Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PhoneNumber" type="text" placeholder="Enter PhoneNumber" v-model="userDetails.phoneNumber"></input>
																		</div>
						</td>
														</tr>
